...
const workingRange = endWorkProgram - startWorkProgram;
...
//  GET TIME AND TOTAL PRICE FOR CHECKED SERVICES ==========================================
function GetServicesData(app)
{
    let total = 0;
    let time = 0;
    ...
    //         GetHourRange(currentYear, currentMonth, currentDay, user, startWorkProgram, stepMin, workingRange);
    //     }
    // });
// }


// function GetHourRange(currentYear, currentMonth, selectDay, user, startWorkProgram, stepMin, workingRange)
// {
//     let getStartHour;
//     let getStartMin;
//     let getEndHour;
...
//         success: function(data){
//             for (let i = 0; i < data.appCount; i++){
//                 getStartHour = data.app[i]['start_at'].substring(0,2);
//                 getStartMin = data.app[i]['start_at'].substring(3,5);
//                 getEndHour = data.app[i]['end_at'].substring(0,2);
//                 getEndMin = data.app[i]['end_at'].substring(3,5);

//                 // Mark by 1 the appointment time
//                 for (let j = getStartHour; j <= getEndHour; j++){
//                     if (j != getEndHour)
//                         for (let k = getStartMin/stepMin; k < 60/stepMin; k++)
//                             time[j - startWorkProgram][k] = 1;
//                     else
//                         for (let k = 0; k <= getEndMin/stepMin; k++)
//                             time[j - startWorkProgram][k] = 1;
//                 }
//             }
//             alert(time);
